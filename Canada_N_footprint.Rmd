...
CCHS_food_names <- read_excel("Data/Food/Consumption/cchs-82M0024-E-2015-nu-side_EDITED.xlsx")%>%
...
# plant milks "BNSD10J"
# egg alternative "BNSD16B"
# animal fats "BNSD21B" "BNSD21C"
# Lamb "BNSD24A" "BNSD24B"
# other meat "BNSD27C" "BNSD27D" "BNSD27E" "BNSD27F" "BNSD28A" "BNSD28B" "BNSD29A" "BNSD30A" "BNSD31A" "BNSD32A" 
# nuts "BNSD33A" "BNSD33B" "BNSD33C"
...
food_consum_raw <- read_csv("Data/Food/Consumption/cchs-82M0024-E-2015-nu-side_F1.csv")
...
food_consum_kg <- food_consum_raw%>%
  ...
  drop_na()%>%
  mutate(consumed_year_kg = value * 365 / 1000)%>%
  group_by(GEO, food_group)%>%
  summarise(eaten_kg_cap = mean(value))
