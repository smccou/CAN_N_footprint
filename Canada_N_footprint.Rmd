...
#detailed food spending https://www150.statcan.gc.ca/t1/tbl1/en/tv.action?pid=1110012501
...
CCHS_food_names <- read_excel("Data/Food/Consumption/cchs-82M0024-E-2015-nu-nci_EDITED.xlsx")%>%
  ...
  mutate(food_group = case_when(BNS_code %in% c("BNSD01A", "BNSD01B", "BNSD01C", "BNSD02A", "BNSD03A", "BNSD03B", "BNSD04A", "BNSD04B", "BNSD04C", "BNSD04D", "BNSD04E", "BNSD04F", "BNSD05A", "BNSD06A", "BNSD07A", "BNSD07B", "BNSD07C", "BNSD08A", "BNSD08B", "BNSD08C") ~ "cereals",
                                ...
                                BNS_code %in% c("BNSD18A", "BNSD18B", "BNSD20A", "BNSD21A") ~ "vegetable oils",
                                ...
                                BNS_code %in% c("BNSD36A", "BNSD36B", "BNSD36C", "BNSD36D", "BNSD36E", "BNSD36F", "BNSD36G", "BNSD36H", "BNSD36I", "BNSD36J", "BNSD36K", "BNSD36L", "BNSD36M", "BNSD36N", "BNSD36O", "BNSD36P") ~ "vegetables",
                                BNS_code %in% c("BNSD33A", "BNSD33B", "BNSD33C") ~ "nuts",
                                BNS_code %in% c("BNSD37A", "BNSD37B")~ "pulses",
                                BNS_code %in% c("BNSD38A", "BNSD38B", "BNSD39A") ~ "roots",
                                BNS_code %in% c("BNSD40A", "BNSD40B", "BNSD40C", "BNSD40D", "BNSD40E", "BNSD40F", "BNSD40G", "BNSD40H", "BNSD40I", "BNSD40J", "BNSD40K", "BNSD40L") ~ "fruit"
 ))
# plant milks "BNSD10J"
...
food_consum_kg_NCI <- food_consum_nci_raw%>%
...
#cross referenced total protein intake (FSDDPRO) with my estimated sum of food protein +/ - ~ 7%
  group_by(BNS_name)%>%
#cross referenced with food available in Canada on StatsCan https://www150.statcan.gc.ca/t1/tbl1/en/tv.action?pid=3210005401, pretty close!!
  summarise(consumed_g_cap = mean(value)*365, consumed_N_g_cap = mean(consumed_protein_g)*365*0.16)

#One-way ANOVA (test is there a difference in consumption of food groups between provinces?)
aov_food <- aov(BNSD05A ~ GEO_PRV, data = food_cons_raw)
summary(aov_food)

aov_food <- (aov(value ~ GEO, data = food_consum_kg)) 
summary(aov_food)
