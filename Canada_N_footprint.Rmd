...
Data from the CCHS (NCI as more updated as compared to SIDE), N content from Canadian nutrient file #use national availability stats and adjust them by CCHS data
...
ggplot(N_footprint, aes(fill = `Subsector`, y = `N kg/cap`, x = GEO))+
